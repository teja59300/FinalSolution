...
namespace OrderApi
{
    public class Startup
    {
        ...
        public IServiceProvider ConfigureServices(IServiceCollection services)
        {
            ...
            var password = Environment.GetEnvironmentVariable("SA_PASSWORD") ?? "Microsoftlab#12";
            var database = Environment.GetEnvironmentVariable("DATABASE") ?? "OrdersDb";

            var connectionString = $"Server={hostname};Database={database};User ID=vmadmin;Password={password};";
